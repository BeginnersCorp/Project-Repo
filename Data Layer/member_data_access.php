...
<?php
	...
	{
        $sql = "INSERT INTO member(Member_ID, Name, Email, Password) VALUES ('$member[Member_ID]', '$member[Name]', '$member[Email]', '$member[Password]')" ;
	...
	{
        $sql = "UPDATE member SET Name='$member[Name]',Email='$member[Email]', Password='$member[Password]' WHERE Member_ID='$member[Member_ID]'";
        $result = executeSQL($sql);
        return $result;
    }
